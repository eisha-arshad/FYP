...
//   const [activeTab, setActiveTab] = useState("overview"); // "overview" | "comments" | "meetings"
...
//   // Open details drawer (with which tab to show)
...
//     try {
//       const reqs = [];
//       // Preload based on tab (but fetching both is fine; optimize network if you like)
//       if (tab === "comments" || tab === "overview" || tab === "meetings") {
//         reqs.push(
//           api.get(`/api/projects/${project.id}/comments/`).catch(() => ({ data: [] }))
//         );
//         reqs.push(
//           api.get(`/api/projects/${project.id}/meetings/`).catch(() => ({ data: [] }))
//         );
//         const [cRes, mRes] = await Promise.all(reqs);
//         setComments(cRes.data || []);
//         setMeetings(mRes.data || []);
//       }
//     } catch (e) {
//       showToast("Failed to load comments/meetings.", "error");
//     } finally {
...
//                           onClick={() => openDetails(p, "overview")}
//                           title="View Overview"
//                         >
//                           View
//                         </button>
...
//                           onClick={() => openDetails(p, "comments")}
//                           title="Open Comments"
//                         >
//                           Comments
//                         </button>
...
//                           onClick={() => openDetails(p, "meetings")}
//                           title="Open Meetings"
//                         >
//                           Meetings
//                         </button>
...
//                           ? `${activeProject.evaluation.evaluator_name || activeProject.evaluation.evaluator_email}`
//                           : "Not assigned yet"}
//                       </div>
//                       <div>
//                         <b>Created:</b>{" "}
...
//                           placeholder="e.g., Milestone review"
//                         />
//                       </div>
//                       <div className={styles.formRow}>
//                         <label>Start</label>
...
//                           placeholder="What to prepare, agenda, etc."
//                         />
//                       </div>

//                       <button className={styles.primaryBtn} onClick={addMeeting}>
//                         Create Meeting
//                       </button>
//                     </div>
